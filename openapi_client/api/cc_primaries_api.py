...
class CcPrimariesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.common_configs_common_config_id_cc_primaries_cc_primary_id_delete_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_primaries/{CcPrimaryId}',
                'operation_id': 'common_configs_common_config_id_cc_primaries_cc_primary_id_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.common_configs_common_config_id_cc_primaries_cc_primary_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCcPrimary,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_primaries/{CcPrimaryId}',
                'operation_id': 'common_configs_common_config_id_cc_primaries_cc_primary_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.common_configs_common_config_id_cc_primaries_cc_primary_id_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_primaries/{CcPrimaryId}',
                'operation_id': 'common_configs_common_config_id_cc_primaries_cc_primary_id_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.common_configs_common_config_id_cc_primaries_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCcPrimaries,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_primaries',
                'operation_id': 'common_configs_common_config_id_cc_primaries_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.common_configs_common_config_id_cc_primaries_post_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_primaries',
                'operation_id': 'common_configs_common_config_id_cc_primaries_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def common_configs_common_config_id_cc_primaries_cc_primary_id_delete(
        self,
        common_config_id,
        cc_primary_id,
        **kwargs
    ):
        """プライマリネームサーバ設定の削除  # noqa: E501

        指定したCcPrimaryIdのプライマリネームサーバを削除します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_primaries_cc_primary_id_delete(common_config_id, cc_primary_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['common_config_id'] = \
            common_config_id
        kwargs['cc_primary_id'] = \
            cc_primary_id
        return self.common_configs_common_config_id_cc_primaries_cc_primary_id_delete_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_primaries_cc_primary_id_get(
        self,
        common_config_id,
        cc_primary_id,
        **kwargs
    ):
        """プライマリネームサーバ設定の取得  # noqa: E501

        指定したCcPrimaryIdのプライマリネームサーバを取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_primaries_cc_primary_id_get(common_config_id, cc_primary_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['cc_primary_id'] = \
            cc_primary_id
        return self.common_configs_common_config_id_cc_primaries_cc_primary_id_get_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_primaries_cc_primary_id_patch(
        self,
        common_config_id,
        cc_primary_id,
        **kwargs
    ):
        """プライマリネームサーバ設定の更新  # noqa: E501

        指定したCcPrimaryIdのプライマリネームサーバを更新します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_primaries_cc_primary_id_patch(common_config_id, cc_primary_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_cc_primary (PatchCcPrimary): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['cc_primary_id'] = \
            cc_primary_id
        return self.common_configs_common_config_id_cc_primaries_cc_primary_id_patch_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_primaries_get(
        self,
        common_config_id,
        **kwargs
    ):
        """プライマリネームサーバ設定の一覧取得  # noqa: E501

        プライマリネームサーバの設定の一覧を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_primaries_get(common_config_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['common_config_id'] = \
            common_config_id
        return self.common_configs_common_config_id_cc_primaries_get_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_primaries_post(
        self,
        common_config_id,
        **kwargs
    ):
        """プライマリネームサーバ設定の作成  # noqa: E501

        新しくプライマリネームサーバを作成します。\\ 作成できる最大件数は5件です。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_primaries_post(common_config_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            post_cc_primary (PostCcPrimary): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['common_config_id'] = \
            common_config_id
        return self.common_configs_common_config_id_cc_primaries_post_endpoint.call_with_http_info(**kwargs)
