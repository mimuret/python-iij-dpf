...
class CcSecNotifiedServersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_delete_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_sec_notified_servers/{CcSecNotifiedServerId}',
                'operation_id': 'common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'cc_sec_notified_server_id': 'CcSecNotifiedServerId',
                },
                'location_map': {
                    'common_config_id': 'path',
                    'cc_sec_notified_server_id': 'path',
                },
        ...
        self.common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCcSecNotifiedServer,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_sec_notified_servers/{CcSecNotifiedServerId}',
                'operation_id': 'common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_sec_notified_servers/{CcSecNotifiedServerId}',
                'operation_id': 'common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'common_config_id': 'path',
                    'cc_sec_notified_server_id': 'path',
                    'patch_cc_sec_notified_server': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.common_configs_common_config_id_cc_sec_notified_servers_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCcSecNotifiedServers,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_sec_notified_servers',
                'operation_id': 'common_configs_common_config_id_cc_sec_notified_servers_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.common_configs_common_config_id_cc_sec_notified_servers_post_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_sec_notified_servers',
                'operation_id': 'common_configs_common_config_id_cc_sec_notified_servers_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'common_config_id': 'path',
                    'post_cc_sec_notified_server': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_delete(
        self,
        common_config_id,
        cc_sec_notified_server_id,
        **kwargs
    ):
        """DNS NOTIFY設定の削除  # noqa: E501

        指定したCcSecNotifiedServerIdのDNS NOTIFYを削除します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_delete(common_config_id, cc_sec_notified_server_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['common_config_id'] = \
            common_config_id
        kwargs['cc_sec_notified_server_id'] = \
            cc_sec_notified_server_id
        return self.common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_delete_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_get(
        self,
        common_config_id,
        cc_sec_notified_server_id,
        **kwargs
    ):
        """DNS NOTIFY設定の取得  # noqa: E501

        指定したCcSecNotifiedServerIdのDNS NOTIFYを取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_get(common_config_id, cc_sec_notified_server_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['cc_sec_notified_server_id'] = \
            cc_sec_notified_server_id
        return self.common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_get_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_patch(
        self,
        common_config_id,
        cc_sec_notified_server_id,
        **kwargs
    ):
        """DNS NOTIFY設定の更新  # noqa: E501

        指定したCcSecNotifiedServerIdのDNS NOTIFYを更新します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_patch(common_config_id, cc_sec_notified_server_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_cc_sec_notified_server (PatchCcSecNotifiedServer): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['cc_sec_notified_server_id'] = \
            cc_sec_notified_server_id
        return self.common_configs_common_config_id_cc_sec_notified_servers_cc_sec_notified_server_id_patch_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_sec_notified_servers_get(
        self,
        common_config_id,
        **kwargs
    ):
        """DNS NOTIFY設定の一覧取得  # noqa: E501

        DNS NOTIFYの設定の一覧を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_sec_notified_servers_get(common_config_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['common_config_id'] = \
            common_config_id
        return self.common_configs_common_config_id_cc_sec_notified_servers_get_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_sec_notified_servers_post(
        self,
        common_config_id,
        **kwargs
    ):
        """DNS NOTIFY設定の作成  # noqa: E501

        新しくDNS NOFITYを作成します。\\ 作成できる最大件数は256件です。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_sec_notified_servers_post(common_config_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            post_cc_sec_notified_server (PostCcSecNotifiedServer): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['common_config_id'] = \
            common_config_id
        return self.common_configs_common_config_id_cc_sec_notified_servers_post_endpoint.call_with_http_info(**kwargs)
