...
class CcSecTransferAclsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_delete_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_sec_transfer_acls/{CcSecTransferAclId}',
                'operation_id': 'common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'cc_sec_transfer_acl_id': 'CcSecTransferAclId',
                },
                'location_map': {
                    'common_config_id': 'path',
                    'cc_sec_transfer_acl_id': 'path',
                },
        ...
        self.common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCcSecTransferAcl,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_sec_transfer_acls/{CcSecTransferAclId}',
                'operation_id': 'common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_sec_transfer_acls/{CcSecTransferAclId}',
                'operation_id': 'common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'common_config_id': 'path',
                    'cc_sec_transfer_acl_id': 'path',
                    'patch_cc_sec_transfer_acl': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.common_configs_common_config_id_cc_sec_transfer_acls_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCcSecTransferAcls,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_sec_transfer_acls',
                'operation_id': 'common_configs_common_config_id_cc_sec_transfer_acls_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.common_configs_common_config_id_cc_sec_transfer_acls_post_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/common_configs/{CommonConfigId}/cc_sec_transfer_acls',
                'operation_id': 'common_configs_common_config_id_cc_sec_transfer_acls_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_delete(
        self,
        common_config_id,
        cc_sec_transfer_acl_id,
        **kwargs
    ):
        """ゾーン転送ACLの削除  # noqa: E501

        指定したCcSecTransferAclIdのゾーン転送ACLを削除します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_delete(common_config_id, cc_sec_transfer_acl_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['common_config_id'] = \
            common_config_id
        kwargs['cc_sec_transfer_acl_id'] = \
            cc_sec_transfer_acl_id
        return self.common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_delete_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_get(
        self,
        common_config_id,
        cc_sec_transfer_acl_id,
        **kwargs
    ):
        """ゾーン転送ACLの取得  # noqa: E501

        指定したCcSecTransferAclIdのゾーン転送ACLを取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_get(common_config_id, cc_sec_transfer_acl_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['cc_sec_transfer_acl_id'] = \
            cc_sec_transfer_acl_id
        return self.common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_get_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_patch(
        self,
        common_config_id,
        cc_sec_transfer_acl_id,
        **kwargs
    ):
        """ゾーン転送ACLの更新  # noqa: E501

        指定したCcSecTransferAclIdのゾーン転送ACLを更新します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_patch(common_config_id, cc_sec_transfer_acl_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_cc_sec_transfer_acl (PatchCcSecTransferAcl): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['cc_sec_transfer_acl_id'] = \
            cc_sec_transfer_acl_id
        return self.common_configs_common_config_id_cc_sec_transfer_acls_cc_sec_transfer_acl_id_patch_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_sec_transfer_acls_get(
        self,
        common_config_id,
        **kwargs
    ):
        """ゾーン転送ACLの一覧取得  # noqa: E501

        ゾーン転送ACLの設定の一覧を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_sec_transfer_acls_get(common_config_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['common_config_id'] = \
            common_config_id
        return self.common_configs_common_config_id_cc_sec_transfer_acls_get_endpoint.call_with_http_info(**kwargs)

    def common_configs_common_config_id_cc_sec_transfer_acls_post(
        self,
        common_config_id,
        **kwargs
    ):
        """ゾーン転送ACLの作成  # noqa: E501

        新しくゾーン転送ACLを作成します。\\ 作成できる最大件数は5件です。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.common_configs_common_config_id_cc_sec_transfer_acls_post(common_config_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            post_cc_sec_transfer_acl (PostCcSecTransferAcl): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['common_config_id'] = \
            common_config_id
        return self.common_configs_common_config_id_cc_sec_transfer_acls_post_endpoint.call_with_http_info(**kwargs)
