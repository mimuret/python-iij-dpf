...
class CommonConfigsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.contracts_contract_id_common_configs_common_config_id_copy_post_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/common_configs/{CommonConfigId}/copy',
                'operation_id': 'contracts_contract_id_common_configs_common_config_id_copy_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'common_config_id': 'CommonConfigId',
                },
                'location_map': {
                    'contract_id': 'path',
                    'common_config_id': 'path',
                    'post_common_config': 'body',
                },
        ...
        self.contracts_contract_id_common_configs_common_config_id_delete_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/common_configs/{CommonConfigId}',
                'operation_id': 'contracts_contract_id_common_configs_common_config_id_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.contracts_contract_id_common_configs_common_config_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCommonConfig,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/common_configs/{CommonConfigId}',
                'operation_id': 'contracts_contract_id_common_configs_common_config_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.contracts_contract_id_common_configs_common_config_id_managed_dns_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/common_configs/{CommonConfigId}/managed_dns',
                'operation_id': 'contracts_contract_id_common_configs_common_config_id_managed_dns_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.contracts_contract_id_common_configs_common_config_id_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/common_configs/{CommonConfigId}',
                'operation_id': 'contracts_contract_id_common_configs_common_config_id_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.contracts_contract_id_common_configs_count_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCount,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/common_configs/count',
                'operation_id': 'contracts_contract_id_common_configs_count_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'keywords_description': '_keywords_description[]',
                },
                'location_map': {
                    'contract_id': 'path',
                    'type': 'query',
        ...
        self.contracts_contract_id_common_configs_default_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/common_configs/default',
                'operation_id': 'contracts_contract_id_common_configs_default_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'contract_id': 'path',
                    'patch_default_common_config': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.contracts_contract_id_common_configs_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCommonConfigs,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/common_configs',
                'operation_id': 'contracts_contract_id_common_configs_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.contracts_contract_id_common_configs_post_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/common_configs',
                'operation_id': 'contracts_contract_id_common_configs_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def contracts_contract_id_common_configs_common_config_id_copy_post(
        self,
        contract_id,
        common_config_id,
        **kwargs
        ...
        指定した共通設定と同じ内容の共通設定を別の共通設定名で作成します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_common_configs_common_config_id_copy_post(contract_id, common_config_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            post_common_config (PostCommonConfig): [optional]
        ...
        kwargs['contract_id'] = \
            contract_id
        kwargs['common_config_id'] = \
            common_config_id
        return self.contracts_contract_id_common_configs_common_config_id_copy_post_endpoint.call_with_http_info(**kwargs)

    def contracts_contract_id_common_configs_common_config_id_delete(
        self,
        contract_id,
        common_config_id,
        **kwargs
        ...
        指定したCommonConfigIdの共通設定を削除します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_common_configs_common_config_id_delete(contract_id, common_config_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['common_config_id'] = \
            common_config_id
        return self.contracts_contract_id_common_configs_common_config_id_delete_endpoint.call_with_http_info(**kwargs)

    def contracts_contract_id_common_configs_common_config_id_get(
        self,
        contract_id,
        common_config_id,
        **kwargs
        ...
        指定したCommonConfigIdの共通設定を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_common_configs_common_config_id_get(contract_id, common_config_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['common_config_id'] = \
            common_config_id
        return self.contracts_contract_id_common_configs_common_config_id_get_endpoint.call_with_http_info(**kwargs)

    def contracts_contract_id_common_configs_common_config_id_managed_dns_patch(
        self,
        contract_id,
        common_config_id,
        **kwargs
    ):
        """マネージドDNSサーバの状態更新  # noqa: E501

        マネージドDNSサーバをプライマリネームサーバとして有効もしくは無効とするかの切り替えを行えます。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_common_configs_common_config_id_managed_dns_patch(contract_id, common_config_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_managed_dns (PatchManagedDns): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['common_config_id'] = \
            common_config_id
        return self.contracts_contract_id_common_configs_common_config_id_managed_dns_patch_endpoint.call_with_http_info(**kwargs)

    def contracts_contract_id_common_configs_common_config_id_patch(
        self,
        contract_id,
        common_config_id,
        **kwargs
        ...
        指定したCommonConfigIdの共通設定を更新します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_common_configs_common_config_id_patch(contract_id, common_config_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_common_config (PatchCommonConfig): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['common_config_id'] = \
            common_config_id
        return self.contracts_contract_id_common_configs_common_config_id_patch_endpoint.call_with_http_info(**kwargs)

    def contracts_contract_id_common_configs_count_get(
        self,
        contract_id,
        **kwargs
    ):
        ...
        共通設定の件数を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_common_configs_count_get(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['contract_id'] = \
            contract_id
        return self.contracts_contract_id_common_configs_count_get_endpoint.call_with_http_info(**kwargs)

    def contracts_contract_id_common_configs_default_patch(
        self,
        contract_id,
        **kwargs
    ):
        """初期適用される共通設定の更新  # noqa: E501

        ゾーンを新規追加した場合に、自動で適用される共通設定を切り替えます。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_common_configs_default_patch(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_default_common_config (PatchDefaultCommonConfig): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['contract_id'] = \
            contract_id
        return self.contracts_contract_id_common_configs_default_patch_endpoint.call_with_http_info(**kwargs)

    def contracts_contract_id_common_configs_get(
        self,
        contract_id,
        **kwargs
    ):
        ...
        共通設定の一覧を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_common_configs_get(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['contract_id'] = \
            contract_id
        return self.contracts_contract_id_common_configs_get_endpoint.call_with_http_info(**kwargs)

    def contracts_contract_id_common_configs_post(
        self,
        contract_id,
        **kwargs
    ):
        ...
        新しく共通設定を作成します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_common_configs_post(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['contract_id'] = \
            contract_id
        return self.contracts_contract_id_common_configs_post_endpoint.call_with_http_info(**kwargs)
