...
class ContractPartnersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.contracts_contract_id_contract_partners_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetContractPartners,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/contract_partners',
                'operation_id': 'contracts_contract_id_contract_partners_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def contracts_contract_id_contract_partners_get(
        self,
        contract_id,
        **kwargs
    ):
        """DPF連携サービスの一覧取得  # noqa: E501

        DPFが連携しているサービスの一覧を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_contract_partners_get(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['contract_id'] = \
            contract_id
        return self.contracts_contract_id_contract_partners_get_endpoint.call_with_http_info(**kwargs)
