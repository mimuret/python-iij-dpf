...
class ContractsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.contracts_contract_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetContract,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}',
                'operation_id': 'contracts_contract_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.contracts_contract_id_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}',
                'operation_id': 'contracts_contract_id_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.contracts_count_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCount,),
                'auth': [],
                'endpoint_path': '/contracts/count',
                'operation_id': 'contracts_count_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.contracts_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetContracts,),
                'auth': [],
    ...
    def contracts_contract_id_get(
        ...
        **kwargs
        ...
        """DPF契約情報の取得  # noqa: E501

        指定したContractIdのDPF契約を取得します。  ### Authorizations dpf_read   # noqa: E501
        ...
        kwargs['contract_id'] = \
            contract_id
        return self.contracts_contract_id_get_endpoint.call_with_http_info(**kwargs)

    def contracts_contract_id_patch(
        self,
        contract_id,
        **kwargs
    ):
        """DPF契約情報の更新  # noqa: E501

        指定したContractIdのDPF契約を更新します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_patch(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_contract (PatchContract): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['contract_id'] = \
            contract_id
        return self.contracts_contract_id_patch_endpoint.call_with_http_info(**kwargs)

    def contracts_count_get(
        self,
        **kwargs
    ):
        """DPF契約情報の件数取得  # noqa: E501

        DPF契約の件数を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_count_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.contracts_count_get_endpoint.call_with_http_info(**kwargs)

    def contracts_get(
        self,
        **kwargs
    ):
        """DPF契約情報の一覧取得  # noqa: E501

        DPF契約情報の一覧を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.contracts_get_endpoint.call_with_http_info(**kwargs)
