...
class DefaultTtlApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.zones_zone_id_default_ttl_changes_delete_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/default_ttl/changes',
                'operation_id': 'zones_zone_id_default_ttl_changes_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_default_ttl_diffs_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetDefaultTtlDiffs,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/default_ttl/diffs',
                'operation_id': 'zones_zone_id_default_ttl_diffs_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_default_ttl_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetDefaultTtl,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/default_ttl',
                'operation_id': 'zones_zone_id_default_ttl_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_default_ttl_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/default_ttl',
                'operation_id': 'zones_zone_id_default_ttl_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def zones_zone_id_default_ttl_changes_delete(
        self,
        zone_id,
        **kwargs
    ):
        """編集中デフォルトTTLの取消  # noqa: E501

        デフォルトTTLの操作を取消します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_default_ttl_changes_delete(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_default_ttl_changes_delete_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_default_ttl_diffs_get(
        self,
        zone_id,
        **kwargs
    ):
        """デフォルトTTLの編集差分の取得  # noqa: E501

        現在DNSに登録されているデフォルトTTLと反映予定のデフォルトTTLの差分一覧を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_default_ttl_diffs_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_default_ttl_diffs_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_default_ttl_get(
        self,
        zone_id,
        **kwargs
    ):
        """デフォルトTTLの取得  # noqa: E501

        デフォルトTTLの一覧を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_default_ttl_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_default_ttl_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_default_ttl_patch(
        self,
        zone_id,
        **kwargs
    ):
        """デフォルトTTLの更新  # noqa: E501

        デフォルトTTLを更新します。\\ **[編集中レコードのゾーン反映](#tag/zones/paths/~1zones~1{ZoneId}~1changes/patch)**を実行するまでは権威サーバには反映されません。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_default_ttl_patch(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_default_ttl (PatchDefaultTtl): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_default_ttl_patch_endpoint.call_with_http_info(**kwargs)
