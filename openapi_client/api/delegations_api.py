...
class DelegationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delegations_count_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCount,),
                'auth': [],
                'endpoint_path': '/delegations/count',
                'operation_id': 'delegations_count_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'keywords_requested': '_keywords_requested[]',
                },
                'location_map': {
                    'type': 'query',
        ...
        self.delegations_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetDelegations,),
                'auth': [],
                'endpoint_path': '/delegations',
                'operation_id': 'delegations_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.delegations_post_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/delegations',
                'operation_id': 'delegations_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def delegations_count_get(
        self,
        **kwargs
    ):
        """ネームサーバ申請候補の件数取得  # noqa: E501

        ネームサーバとして申請可能なゾーンの候補の件数を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delegations_count_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.delegations_count_get_endpoint.call_with_http_info(**kwargs)

    def delegations_get(
        self,
        **kwargs
    ):
        """ネームサーバ申請候補の一覧取得  # noqa: E501

        ネームサーバとして申請可能なゾーンの候補の一覧を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delegations_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.delegations_get_endpoint.call_with_http_info(**kwargs)
    ...
    def delegations_post(
        ...
        **kwargs
        ...
        指定したゾーンを申請します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delegations_post(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            post_delegations (PostDelegations): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.delegations_post_endpoint.call_with_http_info(**kwargs)
