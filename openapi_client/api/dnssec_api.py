...
class DnssecApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.zones_zone_id_dnssec_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetDnssec,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/dnssec',
                'operation_id': 'zones_zone_id_dnssec_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_dnssec_ksk_rollover_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/dnssec/ksk_rollover',
                'operation_id': 'zones_zone_id_dnssec_ksk_rollover_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_dnssec_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/dnssec',
                'operation_id': 'zones_zone_id_dnssec_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def zones_zone_id_dnssec_get(
        self,
        zone_id,
        **kwargs
    ):
        """DNSSEC情報の取得  # noqa: E501

        DNSSEC情報の一覧を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_dnssec_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_dnssec_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_dnssec_ksk_rollover_patch(
        self,
        zone_id,
        **kwargs
    ):
        """KSKロールオーバーの開始  # noqa: E501

        指定したゾーンに対してKSKロールオーバーを開始します。\\ ロールオーバーはds_stateが「3」の場合のみ開始できます。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_dnssec_ksk_rollover_patch(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_dnssec_ksk_rollover_patch_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_dnssec_patch(
        self,
        zone_id,
        **kwargs
    ):
        """DNSSEC情報の更新  # noqa: E501

        DNSSECの情報を更新します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_dnssec_patch(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_dnssec (PatchDnssec): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_dnssec_patch_endpoint.call_with_http_info(**kwargs)
