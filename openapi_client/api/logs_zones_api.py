...
class LogsZonesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.zones_zone_id_logs_count_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCount,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/logs/count',
                'operation_id': 'zones_zone_id_logs_count_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_logs_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetZonesLogs,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/logs',
                'operation_id': 'zones_zone_id_logs_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def zones_zone_id_logs_count_get(
        self,
        zone_id,
        **kwargs
    ):
        """ゾーン操作ログの件数取得  # noqa: E501

        ゾーンを操作したログの件数を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_logs_count_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_logs_count_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_logs_get(
        self,
        zone_id,
        **kwargs
    ):
        """ゾーン操作ログの一覧取得  # noqa: E501

        ゾーンを操作したログの一覧を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_logs_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_logs_get_endpoint.call_with_http_info(**kwargs)
