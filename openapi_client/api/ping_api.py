...
class PingApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.ping_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetPing,),
                'auth': [],
                'endpoint_path': '/ping',
    ...
    def ping_get(
        ...
        **kwargs
        ...
        APIへの疎通を確認できます。  ### Authorizations dpf_read\\ dpf_write\\ dpf_contract   # noqa: E501
        ...
        return self.ping_get_endpoint.call_with_http_info(**kwargs)
