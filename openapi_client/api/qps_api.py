...
class QpsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.contracts_contract_id_qps_histories_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetQpsHistories,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/qps/histories',
                'operation_id': 'contracts_contract_id_qps_histories_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def contracts_contract_id_qps_histories_get(
        self,
        contract_id,
        **kwargs
    ):
        """月別のQPSの一覧取得  # noqa: E501

        DPF契約の月別のQPSを取得できます。\\ DPF契約に紐付くゾーンの月別のQPSと、\\ ゾーンのクエリ数を元に集計したDPF契約の月別のQPSが取得できます。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_qps_histories_get(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['contract_id'] = \
            contract_id
        return self.contracts_contract_id_qps_histories_get_endpoint.call_with_http_info(**kwargs)
