...
class RecordsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.zones_zone_id_records_count_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCount,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/records/count',
                'operation_id': 'zones_zone_id_records_count_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'keywords_ttl': '_keywords_ttl[]',
                    'keywords_rrtype': '_keywords_rrtype[]',
                    'keywords_rdata': '_keywords_rdata[]',
                ...
                'location_map': {
                    ...
                    'keywords_name': 'query',
                    'keywords_ttl': 'query',
                    'keywords_rrtype': 'query',
                    'keywords_rdata': 'query',
        ...
        self.zones_zone_id_records_currents_count_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCount,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/records/currents/count',
                'operation_id': 'zones_zone_id_records_currents_count_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_records_currents_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetRecords,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/records/currents',
                'operation_id': 'zones_zone_id_records_currents_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_records_diffs_count_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCount,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/records/diffs/count',
                'operation_id': 'zones_zone_id_records_diffs_count_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_records_diffs_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetRecordsDiffs,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/records/diffs',
                'operation_id': 'zones_zone_id_records_diffs_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_records_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetRecords,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/records',
                'operation_id': 'zones_zone_id_records_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_records_post_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/records',
                'operation_id': 'zones_zone_id_records_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_records_record_id_changes_delete_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/records/{RecordId}/changes',
                'operation_id': 'zones_zone_id_records_record_id_changes_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_records_record_id_delete_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/records/{RecordId}',
                'operation_id': 'zones_zone_id_records_record_id_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_records_record_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetRecord,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/records/{RecordId}',
                'operation_id': 'zones_zone_id_records_record_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_records_record_id_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/records/{RecordId}',
                'operation_id': 'zones_zone_id_records_record_id_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def zones_zone_id_records_count_get(
        self,
        zone_id,
        **kwargs
    ):
        ...
        レコード情報の件数を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_records_count_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_records_count_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_records_currents_count_get(
        self,
        zone_id,
        **kwargs
    ):
        """DNS反映済レコードの件数取得  # noqa: E501

        現在DNSに登録されているレコードの件数を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_records_currents_count_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_records_currents_count_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_records_currents_get(
        self,
        zone_id,
        **kwargs
    ):
        """DNS反映済レコードの一覧取得  # noqa: E501

        現在DNSに登録されているレコードの一覧を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_records_currents_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_records_currents_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_records_diffs_count_get(
        self,
        zone_id,
        **kwargs
    ):
        """レコードの編集差分の件数取得  # noqa: E501

        現在DNSに登録されているレコードと反映予定のレコードの差分数を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_records_diffs_count_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_records_diffs_count_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_records_diffs_get(
        self,
        zone_id,
        **kwargs
    ):
        """レコードの編集差分の一覧取得  # noqa: E501

        現在DNSに登録されているレコードと反映予定のレコードの差分一覧を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_records_diffs_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_records_diffs_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_records_get(
        self,
        zone_id,
        **kwargs
    ):
        ...
        レコード情報の一覧を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_records_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_records_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_records_post(
        self,
        zone_id,
        **kwargs
    ):
        ...
        新しくレコードを作成します。\\ **[編集中レコードのゾーン反映](#tag/zones/paths/~1zones~1{ZoneId}~1changes/patch)**を実行するまでは権威サーバには反映されません。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_records_post(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            post_record (PostRecord): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_records_post_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_records_record_id_changes_delete(
        self,
        zone_id,
        record_id,
        **kwargs
    ):
        """編集中レコードの取消  # noqa: E501

        指定したRecordIdのレコードの操作を取消します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_records_record_id_changes_delete(zone_id, record_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['record_id'] = \
            record_id
        return self.zones_zone_id_records_record_id_changes_delete_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_records_record_id_delete(
        self,
        zone_id,
        record_id,
        **kwargs
        ...
        指定したRecordIdのレコードを削除します。\\ **[編集中レコードのゾーン反映](#tag/zones/paths/~1zones~1{ZoneId}~1changes/patch)**を実行するまでは権威サーバには反映されません。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_records_record_id_delete(zone_id, record_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['record_id'] = \
            record_id
        return self.zones_zone_id_records_record_id_delete_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_records_record_id_get(
        self,
        zone_id,
        record_id,
        **kwargs
        ...
        指定したRecordIdのレコードを取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_records_record_id_get(zone_id, record_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['record_id'] = \
            record_id
        return self.zones_zone_id_records_record_id_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_records_record_id_patch(
        self,
        zone_id,
        record_id,
        **kwargs
        ...
        指定したRecordIdのレコードを更新します。\\ **[編集中レコードのゾーン反映](#tag/zones/paths/~1zones~1{ZoneId}~1changes/patch)**を実行するまでは権威サーバには反映されません。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_records_record_id_patch(zone_id, record_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_record (PatchRecord): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['record_id'] = \
            record_id
        return self.zones_zone_id_records_record_id_patch_endpoint.call_with_http_info(**kwargs)
