...
class ZoneHistoriesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.zones_zone_id_zone_histories_count_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCount,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/zone_histories/count',
                'operation_id': 'zones_zone_id_zone_histories_count_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_zone_histories_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetZoneHistories,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/zone_histories',
                'operation_id': 'zones_zone_id_zone_histories_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_zone_histories_zone_history_id_text_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetZoneHistoriesText,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/zone_histories/{ZoneHistoryId}/text',
                'operation_id': 'zones_zone_id_zone_histories_zone_history_id_text_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def zones_zone_id_zone_histories_count_get(
        self,
        zone_id,
        **kwargs
    ):
        """ゾーン反映履歴の件数取得  # noqa: E501

        ゾーン反映の履歴の件数を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_zone_histories_count_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_zone_histories_count_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_zone_histories_get(
        self,
        zone_id,
        **kwargs
    ):
        """ゾーン反映履歴の一覧取得  # noqa: E501

        ゾーン反映の履歴の一覧を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_zone_histories_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_zone_histories_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_zone_histories_zone_history_id_text_get(
        self,
        zone_id,
        zone_history_id,
        **kwargs
    ):
        """ゾーン反映時のRFC1035形式のテキストの取得  # noqa: E501

        ゾーン反映の履歴をRFC1035形式のテキストファイルで取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_zone_histories_zone_history_id_text_get(zone_id, zone_history_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        kwargs['zone_history_id'] = \
            zone_history_id
        return self.zones_zone_id_zone_histories_zone_history_id_text_get_endpoint.call_with_http_info(**kwargs)
