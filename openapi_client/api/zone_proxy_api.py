...
class ZoneProxyApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.zones_zone_id_zone_proxy_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetZoneProxy,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/zone_proxy',
                'operation_id': 'zones_zone_id_zone_proxy_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_zone_proxy_health_check_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetZoneProxyHealth,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/zone_proxy/health_check',
                'operation_id': 'zones_zone_id_zone_proxy_health_check_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_zone_proxy_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/zone_proxy',
                'operation_id': 'zones_zone_id_zone_proxy_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def zones_zone_id_zone_proxy_get(
        self,
        zone_id,
        **kwargs
    ):
        """ゾーンプロキシ設定の取得  # noqa: E501

        ゾーンプロキシの設定を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_zone_proxy_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_zone_proxy_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_zone_proxy_health_check_get(
        self,
        zone_id,
        **kwargs
    ):
        """プライマリネームサーバのヘルスチェック結果の取得  # noqa: E501

        ゾーン転送のヘルスチェック結果の一覧を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_zone_proxy_health_check_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_zone_proxy_health_check_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_zone_proxy_patch(
        self,
        zone_id,
        **kwargs
    ):
        """ゾーンプロキシ設定の更新  # noqa: E501

        ゾーンプロキシの設定を更新します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_zone_proxy_patch(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_zone_proxy (PatchZoneProxy): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_zone_proxy_patch_endpoint.call_with_http_info(**kwargs)
