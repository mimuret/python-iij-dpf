...
class ZonesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.zones_count_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCount,),
                'auth': [],
                'endpoint_path': '/zones/count',
                'operation_id': 'zones_count_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
                'all': [
                    'type',
                    'keywords_full_text',
                    'keywords_service_code',
                    'keywords_name',
                    'keywords_network',
                    'keywords_state',
                    'keywords_favorite',
                    'keywords_description',
                    'keywords_common_config_id',
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'keywords_service_code': '_keywords_service_code[]',
                    'keywords_name': '_keywords_name[]',
                    'keywords_network': '_keywords_network[]',
                    'keywords_state': '_keywords_state[]',
                    'keywords_favorite': '_keywords_favorite[]',
                    'keywords_description': '_keywords_description[]',
                    'keywords_common_config_id': '_keywords_common_config_id[]',
                    'keywords_zone_proxy_enabled': '_keywords_zone_proxy_enabled[]',
                },
                'location_map': {
                    'type': 'query',
                    'keywords_full_text': 'query',
                    'keywords_service_code': 'query',
                    'keywords_name': 'query',
                    'keywords_network': 'query',
                    'keywords_state': 'query',
                    'keywords_favorite': 'query',
                    'keywords_description': 'query',
                    'keywords_common_config_id': 'query',
                    'keywords_zone_proxy_enabled': 'query',
                },
        ...
        self.zones_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetZones,),
                'auth': [],
                'endpoint_path': '/zones',
        ...
        self.zones_zone_id_changes_delete_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/changes',
                'operation_id': 'zones_zone_id_changes_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_changes_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/changes',
                'operation_id': 'zones_zone_id_changes_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_contract_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetContract,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/contract',
                'operation_id': 'zones_zone_id_contract_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetZone,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}',
                'operation_id': 'zones_zone_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_managed_dns_servers_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetManagedServers,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}/managed_dns_servers',
                'operation_id': 'zones_zone_id_managed_dns_servers_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.zones_zone_id_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/zones/{ZoneId}',
                'operation_id': 'zones_zone_id_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def zones_count_get(
        ...
        **kwargs
        ...
        DPF契約に紐付くゾーンの件数を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_count_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.zones_count_get_endpoint.call_with_http_info(**kwargs)
    ...
    def zones_get(
        ...
        **kwargs
        ...
        DPF契約に紐付くゾーンの一覧を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.zones_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_changes_delete(
        self,
        zone_id,
        **kwargs
    ):
        """編集中レコードの一括取消  # noqa: E501

        編集中のレコードの操作を一括で取り消します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_changes_delete(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_changes_delete_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_changes_patch(
        self,
        zone_id,
        **kwargs
    ):
        """編集中レコードのゾーン反映  # noqa: E501

        編集中のレコードの操作を反映します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_changes_patch(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_zone_commit (PatchZoneCommit): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_changes_patch_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_contract_get(
        self,
        zone_id,
        **kwargs
    ):
        """ゾーンに紐付くDPF契約情報の取得  # noqa: E501

        指定したZoneIdのゾーンに紐付くDPF契約情報を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_contract_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_contract_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_get(
        self,
        zone_id,
        **kwargs
    ):
        ...
        指定したZoneIdのゾーンを取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_managed_dns_servers_get(
        self,
        zone_id,
        **kwargs
    ):
        """マネージドDNSサーバの一覧取得  # noqa: E501

        指定したZoneIdのマネージドDNSサーバの一覧を取得します。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_managed_dns_servers_get(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_managed_dns_servers_get_endpoint.call_with_http_info(**kwargs)

    def zones_zone_id_patch(
        self,
        zone_id,
        **kwargs
    ):
        ...
        指定したZoneIdのゾーンを更新します。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zones_zone_id_patch(zone_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['zone_id'] = \
            zone_id
        return self.zones_zone_id_patch_endpoint.call_with_http_info(**kwargs)
