...
class ZonesContractsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.contracts_contract_id_zones_common_configs_patch_endpoint = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/zones/common_configs',
                'operation_id': 'contracts_contract_id_zones_common_configs_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.contracts_contract_id_zones_count_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetCount,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/zones/count',
                'operation_id': 'contracts_contract_id_zones_count_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.contracts_contract_id_zones_get_endpoint = _Endpoint(
            settings={
                'response_type': (GetZones,),
                'auth': [],
                'endpoint_path': '/contracts/{ContractId}/zones',
                'operation_id': 'contracts_contract_id_zones_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def contracts_contract_id_zones_common_configs_patch(
        self,
        contract_id,
        **kwargs
    ):
        """DPF契約に紐付くゾーンの共通設定の更新  # noqa: E501

        指定したContractIdの共通設定を切り替えます。  ### Authorizations dpf_write   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_zones_common_configs_patch(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patch_contracts_zones (PatchContractsZones): [optional]
        ...
        kwargs['contract_id'] = \
            contract_id
        return self.contracts_contract_id_zones_common_configs_patch_endpoint.call_with_http_info(**kwargs)

    def contracts_contract_id_zones_count_get(
        self,
        contract_id,
        **kwargs
    ):
        """DPF契約に紐付くゾーンの件数取得  # noqa: E501

        指定したContractIdのDPF契約に紐付くゾーンの件数を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_zones_count_get(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['contract_id'] = \
            contract_id
        return self.contracts_contract_id_zones_count_get_endpoint.call_with_http_info(**kwargs)

    def contracts_contract_id_zones_get(
        self,
        contract_id,
        **kwargs
    ):
        """DPF契約に紐付くゾーンの一覧取得  # noqa: E501

        指定したContractIdのDPF契約に紐付くゾーンの一覧を取得します。\\ \"_keywords\" から始まるパラメータは、合計で30個まで指定可能です。  ### Authorizations dpf_read   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_contract_id_zones_get(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['contract_id'] = \
            contract_id
        return self.contracts_contract_id_zones_get_endpoint.call_with_http_info(**kwargs)
