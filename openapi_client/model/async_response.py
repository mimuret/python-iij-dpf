...
class AsyncResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, request_id, jobs_url, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, request_id, jobs_url, *args, **kwargs):  # noqa: E501
        """AsyncResponse - a model defined in OpenAPI
