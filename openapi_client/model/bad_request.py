...
class BadRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, request_id, error_type, error_message, error_details, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, request_id, error_type, error_message, error_details, *args, **kwargs):  # noqa: E501
        """BadRequest - a model defined in OpenAPI
