...
class CcPrimary(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, address, tsig_id, enabled, *args, **kwargs):  # noqa: E501
        """CcPrimary - a model defined in OpenAPI

        Args:
            id (Id):
            address (str): IPアドレス
            tsig_id (Id):
            enabled (CcPrimaryEnabled):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, address, tsig_id, enabled, *args, **kwargs):  # noqa: E501
        """CcPrimary - a model defined in OpenAPI
