...
class CcSecTransferAcl(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, network, tsig_id, *args, **kwargs):  # noqa: E501
        """CcSecTransferAcl - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, network, tsig_id, *args, **kwargs):  # noqa: E501
        """CcSecTransferAcl - a model defined in OpenAPI
