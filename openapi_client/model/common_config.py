...
def lazy_import():
    ...
    globals()['CommonConfigDefault'] = CommonConfigDefault
    globals()['CommonConfigName'] = CommonConfigName
    globals()['Description'] = Description
    globals()['Id'] = Id
    globals()['ManagedDnsEnabled'] = ManagedDnsEnabled


class CommonConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (Id,),  # noqa: E501
            'name': (CommonConfigName,),  # noqa: E501
            'managed_dns_enabled': (ManagedDnsEnabled,),  # noqa: E501
            'default': (CommonConfigDefault,),  # noqa: E501
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'name': 'name',  # noqa: E501
        'managed_dns_enabled': 'managed_dns_enabled',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, managed_dns_enabled, default, description, *args, **kwargs):  # noqa: E501
        """CommonConfig - a model defined in OpenAPI

        Args:
            id (Id):
            name (CommonConfigName):
            managed_dns_enabled (ManagedDnsEnabled):
            default (CommonConfigDefault):
        ...
        self.id = id
        self.name = name
        self.managed_dns_enabled = managed_dns_enabled
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, managed_dns_enabled, default, description, *args, **kwargs):  # noqa: E501
        """CommonConfig - a model defined in OpenAPI
