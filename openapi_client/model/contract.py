...
def lazy_import():
    ...
    globals()['ContractFavorite'] = ContractFavorite
    globals()['ContractPlan'] = ContractPlan
    globals()['ContractState'] = ContractState
...
class Contract(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'state': (ContractState,),  # noqa: E501
            'favorite': (ContractFavorite,),  # noqa: E501
            'plan': (ContractPlan,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, service_code, state, favorite, plan, description, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, service_code, state, favorite, plan, description, *args, **kwargs):  # noqa: E501
        """Contract - a model defined in OpenAPI
