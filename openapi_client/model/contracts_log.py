...
def lazy_import():
    ...
    globals()['ContractsLogsLogType'] = ContractsLogsLogType
    globals()['ContractsLogsOperation'] = ContractsLogsOperation
    globals()['ContractsLogsStatus'] = ContractsLogsStatus
    globals()['RequestId'] = RequestId


class ContractsLog(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'log_type': (ContractsLogsLogType,),  # noqa: E501
            'operator': (str,),  # noqa: E501
            'operation': (ContractsLogsOperation,),  # noqa: E501
            'target': (str,),  # noqa: E501
            'request_id': (RequestId,),  # noqa: E501
            'status': (ContractsLogsStatus,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time, log_type, operator, operation, request_id, status, *args, **kwargs):  # noqa: E501
        """ContractsLog - a model defined in OpenAPI

        Args:
            time (datetime):
            log_type (ContractsLogsLogType):
            operator (str): 編集者
            operation (ContractsLogsOperation):
            request_id (RequestId):
            status (ContractsLogsStatus):

        Keyword Args:
            target (str): defaults to ""  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, time, log_type, operator, operation, request_id, status, *args, **kwargs):  # noqa: E501
        """ContractsLog - a model defined in OpenAPI
