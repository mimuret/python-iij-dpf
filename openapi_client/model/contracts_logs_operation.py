...
class ContractsLogsOperation(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            'ADD_CC_PRIMARY': "add_cc_primary",
            'UPDATE_CC_PRIMARY': "update_cc_primary",
            'DELETE_CC_PRIMARY': "delete_cc_primary",
            'ADD_CC_SEC_NOTIFIED_SERVER': "add_cc_sec_notified_server",
            'UPDATE_CC_SEC_NOTIFIED_SERVER': "update_cc_sec_notified_server",
            'DELETE_CC_SEC_NOTIFIED_SERVER': "delete_cc_sec_notified_server",
            'ADD_CC_SEC_TRANSFER_ACL': "add_cc_sec_transfer_acl",
            'UPDATE_CC_SEC_TRANSFER_ACL': "update_cc_sec_transfer_acl",
            'DELETE_CC_SEC_TRANSFER_ACL': "delete_cc_sec_transfer_acl",
            'CREATE_COMMON_CONFIG': "create_common_config",
            'SWITCH_DEFAULT_COMMON_CONFIG': "switch_default_common_config",
            'UPDATE_COMMON_CONFIG': "update_common_config",
            'DELETE_COMMON_CONFIG': "delete_common_config",
            'COPY_COMMON_CONFIG': "copy_common_config",
            'UPDATE_MANAGED_DNS_STATE': "update_managed_dns_state",
            'UPDATE_CONTRACT_DESCRIPTION': "update_contract_description",
            'UPDATE_CONTRACT_FAVORITE': "update_contract_favorite",
            'APPLY_COMMON_CONFIG': "apply_common_config",
            'CREATE_CONTRACT_PARTNERSHIP': "create_contract_partnership",
            'DELETE_CONTRACT_PARTNERSHIP': "delete_contract_partnership",
            'CREATE_TSIG': "create_tsig",
            'UPDATE_TSIG': "update_tsig",
            'DELETE_TSIG': "delete_tsig",
        },
    }
