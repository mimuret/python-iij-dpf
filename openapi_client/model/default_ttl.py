...
def lazy_import():
    ...
    globals()['DefaultTtlState'] = DefaultTtlState
    globals()['DefaultTtlValue'] = DefaultTtlValue


class DefaultTtl(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value': (DefaultTtlValue,),  # noqa: E501
            'state': (DefaultTtlState,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, value, state, operator, *args, **kwargs):  # noqa: E501
        """DefaultTtl - a model defined in OpenAPI

        Args:
            value (DefaultTtlValue):
            state (DefaultTtlState):
            operator (str): 編集者
    ...
    @convert_js_args_to_python_args
    def __init__(self, value, state, operator, *args, **kwargs):  # noqa: E501
        """DefaultTtl - a model defined in OpenAPI
