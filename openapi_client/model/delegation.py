...
class Delegation(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'delegation_requested_at': (datetime,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'description': 'description',  # noqa: E501
        'delegation_requested_at': 'delegation_requested_at',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, service_code, name, network, description, delegation_requested_at, *args, **kwargs):  # noqa: E501
        ...
        self.delegation_requested_at = delegation_requested_at
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, service_code, name, network, description, delegation_requested_at, *args, **kwargs):  # noqa: E501
        """Delegation - a model defined in OpenAPI
