...
def lazy_import():
    ...
    globals()['DnssecDsState'] = DnssecDsState
    globals()['DnssecEnabled'] = DnssecEnabled
    globals()['DnssecState'] = DnssecState


class Dnssec(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'enabled': (DnssecEnabled,),  # noqa: E501
            'state': (DnssecState,),  # noqa: E501
            'ds_state': (DnssecDsState,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, enabled, state, ds_state, *args, **kwargs):  # noqa: E501
        """Dnssec - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, enabled, state, ds_state, *args, **kwargs):  # noqa: E501
        """Dnssec - a model defined in OpenAPI
