...
class DnssecDsState(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """DnssecDsState - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): 詳細説明は**[こちら](#tag/dnssec)**., must be one of [0, 1, 2, 3, 4, 5, 6, 7, 8, ]  # noqa: E501

        Keyword Args:
            value (int): 詳細説明は**[こちら](#tag/dnssec)**., must be one of [0, 1, 2, 3, 4, 5, 6, 7, 8, ]  # noqa: E501
