...
def lazy_import():
    ...
    globals()['NotifiedServer'] = NotifiedServer
    globals()['RequestId'] = RequestId


class GetCcSecNotifiedServer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'result': (NotifiedServer,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, request_id, result, *args, **kwargs):  # noqa: E501
        """GetCcSecNotifiedServer - a model defined in OpenAPI

        Args:
            request_id (RequestId):
            result (NotifiedServer):
