...
class GetCcSecNotifiedServers(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'results': ([NotifiedServer],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetCcSecNotifiedServers - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([NotifiedServer]): defaults to []  # noqa: E501
