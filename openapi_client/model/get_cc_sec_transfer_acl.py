...
def lazy_import():
    ...
    globals()['CcSecTransferAcl'] = CcSecTransferAcl
    globals()['RequestId'] = RequestId


class GetCcSecTransferAcl(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'result': (CcSecTransferAcl,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, request_id, result, *args, **kwargs):  # noqa: E501
        """GetCcSecTransferAcl - a model defined in OpenAPI

        Args:
            request_id (RequestId):
            result (CcSecTransferAcl):
    ...
    @convert_js_args_to_python_args
    def __init__(self, request_id, result, *args, **kwargs):  # noqa: E501
        """GetCcSecTransferAcl - a model defined in OpenAPI
