...
class GetCcSecTransferAcls(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'results': ([CcSecTransferAcl],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetCcSecTransferAcls - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([CcSecTransferAcl]): defaults to []  # noqa: E501
