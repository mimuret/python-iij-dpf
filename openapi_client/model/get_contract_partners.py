...
def lazy_import():
    ...
    globals()['GetContractPartnersResults'] = GetContractPartnersResults
    globals()['RequestId'] = RequestId


class GetContractPartners(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'results': ([GetContractPartnersResults],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetContractPartners - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([GetContractPartnersResults]): defaults to []  # noqa: E501
