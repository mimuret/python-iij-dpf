...
class GetContractPartnersResults(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, service_code, *args, **kwargs):  # noqa: E501
        """GetContractPartnersResults - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, service_code, *args, **kwargs):  # noqa: E501
        """GetContractPartnersResults - a model defined in OpenAPI
