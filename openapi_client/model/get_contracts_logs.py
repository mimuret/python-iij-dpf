...
def lazy_import():
    ...
    globals()['ContractsLog'] = ContractsLog
    globals()['RequestId'] = RequestId


class GetContractsLogs(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'results': ([ContractsLog],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetContractsLogs - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([ContractsLog]): defaults to []  # noqa: E501
