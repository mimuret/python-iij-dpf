...
def lazy_import():
    ...
    globals()['GetDefaultTtlDiffsResults'] = GetDefaultTtlDiffsResults
    globals()['RequestId'] = RequestId


class GetDefaultTtlDiffs(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'results': ([GetDefaultTtlDiffsResults],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetDefaultTtlDiffs - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([GetDefaultTtlDiffsResults]): defaults to []  # noqa: E501
