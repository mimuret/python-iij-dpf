...
def lazy_import():
    ...
    globals()['DefaultTtl'] = DefaultTtl


class GetDefaultTtlDiffsResults(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'new': (DefaultTtl,),  # noqa: E501
            'old': (DefaultTtl,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, new, old, *args, **kwargs):  # noqa: E501
        """GetDefaultTtlDiffsResults - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, new, old, *args, **kwargs):  # noqa: E501
        """GetDefaultTtlDiffsResults - a model defined in OpenAPI
