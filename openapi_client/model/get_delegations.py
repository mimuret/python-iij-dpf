...
def lazy_import():
    ...
    globals()['Delegation'] = Delegation
    globals()['RequestId'] = RequestId


class GetDelegations(ModelNormal):
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetDelegations - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([Delegation]): defaults to []  # noqa: E501
