...
def lazy_import():
    ...
    globals()['DsRecord'] = DsRecord
    globals()['RequestId'] = RequestId


class GetDsRecords(ModelNormal):
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetDsRecords - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([DsRecord]): defaults to []  # noqa: E501
