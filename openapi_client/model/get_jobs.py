...
class GetJobs(ModelNormal):
    ...
    attribute_map = {
        ...
        'resources_url': 'resources_url',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, request_id, status, *args, **kwargs):  # noqa: E501
        """GetJobs - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            resources_url (str): status: SUCCESSFULの場合のみ、レスポンスに含まれます. [optional]  # noqa: E501
            error_type (str): status: FAILEDの場合のみ、レスポンスに含まれます. [optional]  # noqa: E501
            error_message (str): status: FAILEDの場合のみ、レスポンスに含まれます. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, request_id, status, *args, **kwargs):  # noqa: E501
        """GetJobs - a model defined in OpenAPI
