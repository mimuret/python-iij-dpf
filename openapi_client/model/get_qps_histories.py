...
def lazy_import():
    ...
    globals()['QpsHistory'] = QpsHistory
    globals()['RequestId'] = RequestId


class GetQpsHistories(ModelNormal):
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetQpsHistories - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([QpsHistory]): defaults to []  # noqa: E501
