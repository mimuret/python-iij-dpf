...
def lazy_import():
    ...
    globals()['GetRecordsDiffsResults'] = GetRecordsDiffsResults
    globals()['RequestId'] = RequestId


class GetRecordsDiffs(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'results': ([GetRecordsDiffsResults],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetRecordsDiffs - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([GetRecordsDiffsResults]): defaults to []  # noqa: E501
