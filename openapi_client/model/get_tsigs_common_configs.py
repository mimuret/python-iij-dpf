...
class GetTsigsCommonConfigs(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'results': ([CommonConfig],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetTsigsCommonConfigs - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            results ([CommonConfig]): [optional] if omitted the server will use the default value of []  # noqa: E501
        """
