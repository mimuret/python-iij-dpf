...
def lazy_import():
    ...
    globals()['ZoneHistory'] = ZoneHistory


class GetZoneHistories(ModelNormal):
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetZoneHistories - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([ZoneHistory]): defaults to []  # noqa: E501
