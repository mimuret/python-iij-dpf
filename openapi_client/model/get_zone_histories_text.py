...
def lazy_import():
    ...
    globals()['ZoneHistoryText'] = ZoneHistoryText


class GetZoneHistoriesText(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'result': (ZoneHistoryText,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, request_id, result, *args, **kwargs):  # noqa: E501
        """GetZoneHistoriesText - a model defined in OpenAPI

        Args:
            request_id (RequestId):
            result (ZoneHistoryText):
