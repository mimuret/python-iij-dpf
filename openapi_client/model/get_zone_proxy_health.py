...
def lazy_import():
    ...
    globals()['ZoneProxyHealth'] = ZoneProxyHealth


class GetZoneProxyHealth(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'results': ([ZoneProxyHealth],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetZoneProxyHealth - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([ZoneProxyHealth]): defaults to []  # noqa: E501
