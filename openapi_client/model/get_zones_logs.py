...
def lazy_import():
    ...
    globals()['ZonesLog'] = ZonesLog


class GetZonesLogs(ModelNormal):
    ...
    def _from_openapi_data(cls, request_id, *args, **kwargs):  # noqa: E501
        """GetZonesLogs - a model defined in OpenAPI

        Args:
            request_id (RequestId):

        Keyword Args:
            results ([ZonesLog]): defaults to []  # noqa: E501
