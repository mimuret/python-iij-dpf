...
class NotifiedServer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, address, tsig_id, *args, **kwargs):  # noqa: E501
        """NotifiedServer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, address, tsig_id, *args, **kwargs):  # noqa: E501
        """NotifiedServer - a model defined in OpenAPI
