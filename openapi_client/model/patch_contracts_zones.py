...
class PatchContractsZones(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, common_config_id, zone_ids, *args, **kwargs):  # noqa: E501
        """PatchContractsZones - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, common_config_id, zone_ids, *args, **kwargs):  # noqa: E501
        """PatchContractsZones - a model defined in OpenAPI
