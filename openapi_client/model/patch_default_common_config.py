...
class PatchDefaultCommonConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, common_config_id, *args, **kwargs):  # noqa: E501
        """PatchDefaultCommonConfig - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, common_config_id, *args, **kwargs):  # noqa: E501
        """PatchDefaultCommonConfig - a model defined in OpenAPI
