...
class PatchManagedDns(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, managed_dns_enabled, *args, **kwargs):  # noqa: E501
        """PatchManagedDns - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, managed_dns_enabled, *args, **kwargs):  # noqa: E501
        """PatchManagedDns - a model defined in OpenAPI
