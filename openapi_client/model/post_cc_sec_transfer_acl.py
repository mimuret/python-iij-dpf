...
class PostCcSecTransferAcl(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, network, *args, **kwargs):  # noqa: E501
        """PostCcSecTransferAcl - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, network, *args, **kwargs):  # noqa: E501
        """PostCcSecTransferAcl - a model defined in OpenAPI
