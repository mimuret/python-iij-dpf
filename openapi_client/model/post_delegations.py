...
class PostDelegations(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, zone_ids, *args, **kwargs):  # noqa: E501
        """PostDelegations - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, zone_ids, *args, **kwargs):  # noqa: E501
        """PostDelegations - a model defined in OpenAPI
