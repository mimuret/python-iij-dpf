...
class PostRecord(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, rrtype, rdata, *args, **kwargs):  # noqa: E501
        """PostRecord - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            ttl (RecordsTtl): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, rrtype, rdata, *args, **kwargs):  # noqa: E501
        """PostRecord - a model defined in OpenAPI
