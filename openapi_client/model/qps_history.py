...
def lazy_import():
    ...
    globals()['QpsValue'] = QpsValue
    globals()['ServiceCode'] = ServiceCode


class QpsHistory(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, service_code, name, *args, **kwargs):  # noqa: E501
        """QpsHistory - a model defined in OpenAPI
        ...
        Keyword Args:
            values ([QpsValue]): defaults to []  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, service_code, name, *args, **kwargs):  # noqa: E501
        """QpsHistory - a model defined in OpenAPI
