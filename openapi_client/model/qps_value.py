...
class QpsValue(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, month, qps, *args, **kwargs):  # noqa: E501
        """QpsValue - a model defined in OpenAPI

        Args:
            month (str): 集計対象月(YYYY-MM)
            qps (Qps):
    ...
    @convert_js_args_to_python_args
    def __init__(self, month, qps, *args, **kwargs):  # noqa: E501
        """QpsValue - a model defined in OpenAPI
