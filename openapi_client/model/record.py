...
def lazy_import():
    ...
    globals()['RecordsName'] = RecordsName
    globals()['RecordsRdata'] = RecordsRdata
    globals()['RecordsRrtype'] = RecordsRrtype
    globals()['RecordsState'] = RecordsState
    globals()['RecordsTtl'] = RecordsTtl
...
class Record(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (RecordsName,),  # noqa: E501
            'ttl': (RecordsTtl,),  # noqa: E501
            'rrtype': (RecordsRrtype,),  # noqa: E501
            'rdata': (RecordsRdata,),  # noqa: E501
            'state': (RecordsState,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'name': 'name',  # noqa: E501
        'ttl': 'ttl',  # noqa: E501
        'rrtype': 'rrtype',  # noqa: E501
        'rdata': 'rdata',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, ttl, rrtype, rdata, state, description, operator, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, ttl, rrtype, rdata, state, description, operator, *args, **kwargs):  # noqa: E501
        """Record - a model defined in OpenAPI
