...
class RecordsRrtype(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """RecordsRrtype - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): レコードタイプ., must be one of ["A", "AAAA", "ANAME", "CAA", "CNAME", "DS", "HTTPS", "MX", "NAPTR", "NS", "PTR", "SOA", "SRV", "SVCB", "TLSA", "TXT", ]  # noqa: E501

        Keyword Args:
            value (str): レコードタイプ., must be one of ["A", "AAAA", "ANAME", "CAA", "CNAME", "DS", "HTTPS", "MX", "NAPTR", "NS", "PTR", "SOA", "SRV", "SVCB", "TLSA", "TXT", ]  # noqa: E501
