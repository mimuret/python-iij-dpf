...
class SearchLogsLimit(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SearchLogsLimit - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): if omitted defaults to 100  # noqa: E501

        Keyword Args:
            value (int): if omitted defaults to 100  # noqa: E501
