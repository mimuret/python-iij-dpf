...
class SearchOrder(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): if omitted defaults to "ASC", must be one of ["ASC", "DESC", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "ASC", must be one of ["ASC", "DESC", ]  # noqa: E501
