...
def lazy_import():
    ...
    globals()['Id'] = Id
    globals()['TsigsAlgorithm'] = TsigsAlgorithm


class Tsig(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (Id,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'algorithm': (TsigsAlgorithm,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, algorithm, secret, description, *args, **kwargs):  # noqa: E501
        """Tsig - a model defined in OpenAPI

        Args:
            id (Id):
            name (str):
            algorithm (TsigsAlgorithm):
            secret (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, algorithm, secret, description, *args, **kwargs):  # noqa: E501
        """Tsig - a model defined in OpenAPI
