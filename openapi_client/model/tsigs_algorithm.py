...
class TsigsAlgorithm(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TsigsAlgorithm - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): 詳細説明は**[こちら](#tag/tsigs)**. if omitted defaults to 0, must be one of [0, ]  # noqa: E501

        Keyword Args:
            value (int): 詳細説明は**[こちら](#tag/tsigs)**. if omitted defaults to 0, must be one of [0, ]  # noqa: E501
