...
class TsigsPostName(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TsigsPostName - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): 先頭末尾がハイフン以外の[a-z0-9]とハイフンで構成された文字列が使用できます.  # noqa: E501

        Keyword Args:
            value (str): 先頭末尾がハイフン以外の[a-z0-9]とハイフンで構成された文字列が使用できます.  # noqa: E501
