...
def lazy_import():
    ...
    globals()['Id'] = Id
    globals()['ServiceCode'] = ServiceCode
    globals()['SystemId'] = SystemId
    globals()['ZonesEnabled'] = ZonesEnabled
    globals()['ZonesFavorite'] = ZonesFavorite
    globals()['ZonesName'] = ZonesName
    globals()['ZonesState'] = ZonesState
...
class Zone(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'id': (SystemId,),  # noqa: E501
            'common_config_id': (Id,),  # noqa: E501
            'service_code': (ServiceCode,),  # noqa: E501
            'state': (ZonesState,),  # noqa: E501
            'favorite': (ZonesFavorite,),  # noqa: E501
            'name': (ZonesName,),  # noqa: E501
            'network': (str, none_type,),  # noqa: E501
            'description': (Description,),  # noqa: E501
            'zone_proxy_enabled': (ZonesEnabled,),  # noqa: E501
        }
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'common_config_id': 'common_config_id',  # noqa: E501
        'service_code': 'service_code',  # noqa: E501
        'state': 'state',  # noqa: E501
        'favorite': 'favorite',  # noqa: E501
        'name': 'name',  # noqa: E501
        'network': 'network',  # noqa: E501
        'description': 'description',  # noqa: E501
        'zone_proxy_enabled': 'zone_proxy_enabled',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, common_config_id, service_code, state, favorite, name, network, description, zone_proxy_enabled, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            state (ZonesState):
            favorite (ZonesFavorite):
            name (ZonesName):
            network (str, none_type):
            description (Description):
            zone_proxy_enabled (ZonesEnabled):
        ...
        self.id = id
        self.common_config_id = common_config_id
        ...
        self.zone_proxy_enabled = zone_proxy_enabled
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, common_config_id, service_code, state, favorite, name, network, description, zone_proxy_enabled, *args, **kwargs):  # noqa: E501
        """Zone - a model defined in OpenAPI
