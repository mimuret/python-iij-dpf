...
class ZoneHistory(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, committed_at, description, operator, *args, **kwargs):  # noqa: E501
        """ZoneHistory - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, committed_at, description, operator, *args, **kwargs):  # noqa: E501
        """ZoneHistory - a model defined in OpenAPI
