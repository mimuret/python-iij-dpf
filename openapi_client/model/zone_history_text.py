...
class ZoneHistoryText(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (Id,),  # noqa: E501
            'committed_at': (datetime,),  # noqa: E501
            'description': (Description,),  # noqa: E501
            'operator': (str,),  # noqa: E501
            'text': (datetime,),  # noqa: E501
        }
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'committed_at': 'committed_at',  # noqa: E501
        'description': 'description',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, committed_at, description, operator, text, *args, **kwargs):  # noqa: E501
        """ZoneHistoryText - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, committed_at, description, operator, text, *args, **kwargs):  # noqa: E501
        """ZoneHistoryText - a model defined in OpenAPI
