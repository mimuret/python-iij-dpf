...
class ZoneProxyEnabled(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ZoneProxyEnabled - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): 詳細説明は**[こちら](#tag/zone_proxy)**., must be one of [0, 1, ]  # noqa: E501

        Keyword Args:
            value (int): 詳細説明は**[こちら](#tag/zone_proxy)**., must be one of [0, 1, ]  # noqa: E501
