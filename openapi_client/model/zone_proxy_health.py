...
def lazy_import():
    ...
    globals()['ZoneProxyEnabled'] = ZoneProxyEnabled
    globals()['ZoneProxyStatus'] = ZoneProxyStatus


class ZoneProxyHealth(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'status': (ZoneProxyStatus,),  # noqa: E501
            'tsig_name': (str,),  # noqa: E501
            'enabled': (ZoneProxyEnabled,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, status, tsig_name, enabled, *args, **kwargs):  # noqa: E501
        """ZoneProxyHealth - a model defined in OpenAPI

        Args:
            address (str): IPアドレス
            status (ZoneProxyStatus):
            tsig_name (str):
            enabled (ZoneProxyEnabled):
    ...
    @convert_js_args_to_python_args
    def __init__(self, address, status, tsig_name, enabled, *args, **kwargs):  # noqa: E501
        """ZoneProxyHealth - a model defined in OpenAPI
