...
class ZoneProxyStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ZoneProxyStatus - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): 詳細説明は**[こちら](#tag/zone_proxy)**., must be one of ["success", "fail", ]  # noqa: E501

        Keyword Args:
            value (str): 詳細説明は**[こちら](#tag/zone_proxy)**., must be one of ["success", "fail", ]  # noqa: E501
