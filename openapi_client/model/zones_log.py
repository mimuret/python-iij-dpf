...
def lazy_import():
    ...
    globals()['ZonesLogsOperation'] = ZonesLogsOperation
    globals()['ZonesLogsStatus'] = ZonesLogsStatus
    globals()['ZonesLogsType'] = ZonesLogsType


class ZonesLog(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'log_type': (ZonesLogsType,),  # noqa: E501
            'operator': (str,),  # noqa: E501
            'operation': (ZonesLogsOperation,),  # noqa: E501
            'target': (str,),  # noqa: E501
            'request_id': (RequestId,),  # noqa: E501
            'status': (ZonesLogsStatus,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, time, log_type, operator, operation, request_id, status, *args, **kwargs):  # noqa: E501
        """ZonesLog - a model defined in OpenAPI

        Args:
            time (datetime):
            log_type (ZonesLogsType):
            operator (str): 編集者
            operation (ZonesLogsOperation):
            request_id (RequestId):
            status (ZonesLogsStatus):
