...
class ZonesLogsOperation(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            'UPDATING_DEFAULT_TTL': "updating_default_ttl",
            'DISMISS_DEFAULT_TTL_CHANGE': "dismiss_default_ttl_change",
            'UPDATE_DNSSEC_CONFIGURATION': "update_dnssec_configuration",
            'BEGIN_KSK_ROLLOVER': "begin_ksk_rollover",
            'ADDING_RECORD': "adding_record",
            'UPDATING_RECORD': "updating_record",
            'DELETING_RECORD': "deleting_record",
            'DISMISS_RECORD_CHANGE': "dismiss_record_change",
            'UPDATE_ZONE_PROXY': "update_zone_proxy",
            'UPDATE_ZONE_DESCRIPTION': "update_zone_description",
            'UPDATE_ZONE_FAVORITE': "update_zone_favorite",
            'COMMIT_ZONE': "commit_zone",
            'UPLOAD_ZONE': "upload_zone",
            'DISMISS_ZONE_EDITS': "dismiss_zone_edits",
    ...
    def __init__(self, *args, **kwargs):
        """ZonesLogsOperation - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): 詳細説明は**[こちら](#tag/logs-(zones))**., must be one of ["updating_default_ttl", "dismiss_default_ttl_change", "update_dnssec_configuration", "begin_ksk_rollover", "adding_record", "updating_record", "deleting_record", "dismiss_record_change", "update_zone_proxy", "update_zone_description", "update_zone_favorite", "commit_zone", "upload_zone", "dismiss_zone_edits", "create_delegations", ]  # noqa: E501
